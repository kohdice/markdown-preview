...
test "markdown_preview.renderSource produces heading and list output for representative markdown" {
    ...
    const rendered = try facade.renderSourceToOwnedSlice(allocator, source, .{});
